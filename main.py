...
def calculate_advanced_preds(home_lambda, away_lambda):
    ...
    for h in range(6):
        for a in range(6):
            ...
            if p_score > max_score_prob:
                max_score_prob = p_score
    ...
    return (over_25_prob * 100, under_25_prob * 100, gg_prob * 100, ht_over15_prob * 100, over_15_prob * 100, most_likely_score, max_score_prob * 100, p_first_home, p_first_away)
